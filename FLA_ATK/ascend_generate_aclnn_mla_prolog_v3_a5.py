...
A5 supports all quant scenes; this generator emits the 16 legal (wq,kvq,qq)
...
# (weightQuantMode, kvCacheQuantMode, queryQuantMode) — doc 16 legal A5 combos
...
# 11 non-pertile scenes × 6 modes + 5 pertile scenes × 3 modes = 81
...
@GENERATOR_REGISTRY.register("ascend_generate_aclnn_mla_prolog_v3_a5")
class MlaPrologV3A5Generator(CaseGenerator):
    ...
    def after_case_config(self, case_config: CaseConfig) -> CaseConfig:
        seq = MlaPrologV3A5Generator._seq
        MlaPrologV3A5Generator._seq += 1
