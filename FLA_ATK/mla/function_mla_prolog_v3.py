...
"""ATK plugin for aclnnMlaPrologV3WeightNz (self-contained).

Extracted from V4: golden + noncontig + executor + V3 register entries.
V3 has no doRope argument; its reference and DUT always enable RoPE.
"""
...
def _resolve_do_rope(kw: Dict[str, Any]) -> bool:
    """V3 always enables RoPE and does not accept the V4 doRope attribute."""
    if "doRope" in kw:
        raise ValueError("aclnnMlaPrologV3WeightNz does not accept doRope")
    return True
